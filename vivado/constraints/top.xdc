...
if {[llength $sdi_refclk_p_port] > 0} {
    set_property PACKAGE_PIN XX $sdi_refclk_p_port
    create_clock -name sdi_refclk -period 6.734 $sdi_refclk_p_port
}
if {[llength $sdi_refclk_n_port] > 0} {
    set_property PACKAGE_PIN XX $sdi_refclk_n_port
}
...
if {[llength $sdi_rx_p_port] > 0} {
    set_property PACKAGE_PIN XX $sdi_rx_p_port
}
if {[llength $sdi_rx_n_port] > 0} {
    set_property PACKAGE_PIN XX $sdi_rx_n_port
}
...
if {[llength $sdi_tx_p_port] > 0} {
    set_property PACKAGE_PIN XX $sdi_tx_p_port
}
if {[llength $sdi_tx_n_port] > 0} {
    set_property PACKAGE_PIN XX $sdi_tx_n_port
}
...
if {[llength $led_ports] > 0} {
    set_property PACKAGE_PIN XX [get_ports -quiet {led[0]}]
    set_property PACKAGE_PIN XX [get_ports -quiet {led[1]}]
    set_property PACKAGE_PIN XX [get_ports -quiet {led[2]}]
    set_property PACKAGE_PIN XX [get_ports -quiet {led[3]}]
    set_property IOSTANDARD LVCMOS33 $led_ports
